...
""", unsafe_allow_html=True)
    ...
    with col2:
        ...
        if condition_checker_toggle:
            ...
            condition_type = condition_cola[0].selectbox("Condition Type:", ["Rolling_Straddle_Spot_Movement_Tracker", "Rolling_ATM_Premium_Straddle", "Weekly_Positional_With_Adjustments", "RSM_Threshold", "Non_Correlation", 'Delta_ADX', "V_Day", "Momentum1", "SMA", "Striker", "RSI_EXECUTION", "MOMENTUM_EXECUTION"],
                                                         index=0,
                                                         key="condition_type")
